...
public class CrossMove implements Move {
    ...
    public List<Cell> getValidMoves(Piece piece, Cell start) {
        ...
        getMovesFromDirection(isWhite, start, Direction.TOPL, moves);
        getMovesFromDirection(isWhite, start, Direction.TOPR, moves);
        getMovesFromDirection(isWhite, start, Direction.BOTL, moves);
        getMovesFromDirection(isWhite, start, Direction.BOTR, moves);
        return moves;
    }
